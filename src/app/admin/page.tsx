  ...
  return (
    <div className="min-h-screen bg-[#F6F6F6]">
      ...
      <main className="mx-auto max-w-[1280px] px-8 py-12">
        <h1 className="mb-2 text-2xl font-black text-[#00497F]">Bem-vindo ao painel</h1>
          ...
          {isOwner && (
            <a href={MODULO_OWNER.href}
              ...
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#00497F]/10">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#00497F" className="h-6 w-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d={MODULO_OWNER.icon} />
                </svg>
              </div>
              <h2 className="text-lg font-bold text-[#00497F]">{MODULO_OWNER.titulo}</h2>
