    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* CTA desktop — Catálogos + Fale com um Consultor */}
          <div className="hidden items-center gap-3 lg:flex">
            <Link
              href="/catalogo"
              className="flex shrink-0 items-center whitespace-nowrap rounded-[8px] border-2 border-[#006EB7] bg-transparent px-5 py-2 text-sm font-medium text-[#006EB7] transition-colors hover:bg-[#006EB7] hover:text-white"
            >
              Catálogos
            </Link>
            <a
              ...
              onClick={() => trackEvent("click_whatsapp", { local: "header" })}
              className="flex shrink-0 items-center gap-1.5 whitespace-nowrap rounded-[8px] border-2 border-[#006EB7] bg-[#006EB7] px-5 py-2 text-sm font-medium text-white transition-colors hover:bg-white hover:text-[#006EB7]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              ...
              >
                <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z" /><path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.554 4.117 1.528 5.855L0 24l6.335-1.509A11.945 11.945 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.894a9.877 9.877 0 0 1-5.031-1.378l-.361-.214-3.741.981.999-3.648-.235-.374A9.865 9.865 0 0 1 2.106 12C2.106 6.533 6.533 2.106 12 2.106S21.894 6.533 21.894 12 17.467 21.894 12 21.894z" />
              </svg>
              <span className="xl:hidden">Consultor</span>
              <span className="hidden xl:inline">Fale com um Consultor</span>
            </a>
          </div>
      ...
      >
        ...
        <div className="flex flex-col gap-3 px-6 pt-5">
          <Link
            href="/catalogo"
            onClick={close}
            className="flex items-center justify-center rounded-[8px] border-2 border-[#006EB7] bg-white/10 px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-white hover:text-[#00497F]"
          >
            Catálogos
          </Link>
          <a
            ...
            rel="noopener noreferrer"
            onClick={() => {
              trackEvent("click_whatsapp", { local: "header" });
              close();
            }}
            className="flex items-center justify-center gap-2 rounded-[8px] border-2 border-white/20 bg-white/10 px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-white hover:text-[#00497F]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
