      ...
      >
        ...
        >
            ...
            {NAV_LINKS.map((link) =>
              link.dropdown ? (
                ...
                <Link
                  key={link.label}
                  href={link.href}
                  className="font-sans text-sm font-normal text-[#595959] transition-colors hover:text-[#006EB7]"
                >
                  {link.label}
                </Link>
              )
          ...
          <div className="hidden items-center gap-3 lg:flex">
            <Link
              href="#broker"
              className="rounded-[8px] border-2 border-[#006EB7] px-5 py-2 text-sm font-medium text-[#006EB7] transition-colors hover:bg-[#006EB7] hover:text-white"
            >
              Broker Nestlé
            </Link>
            <Link
