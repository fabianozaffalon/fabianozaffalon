        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-16 md:items-center">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm leading-relaxed text-[#595959] md:text-base">
              A nossa história é contada também por alguns casos de sucesso. Confira alguns deles e
              descubra como a Fabiano Zaffalon transforma desafio em resultado.
            </p>
          </div>

          {/* Carrossel de cards — direita */}
                  ...
                  >
                    <div className="relative w-full aspect-[4/3]">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-4">
                        ...
                        <Link
                          href={item.href}
                          className="mt-2 inline-block text-sm font-bold text-white underline underline-offset-2 hover:opacity-80 transition-opacity"
                        >
                          Saiba mais
                        </Link>
                      </div>
