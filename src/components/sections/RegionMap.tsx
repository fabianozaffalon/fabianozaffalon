      ...
      <div className="relative w-full overflow-hidden rounded-2xl h-52 md:h-[420px]">
        ...
        <div
          className={
            ...
            (!activeRegion ? "opacity-100 z-10" : "opacity-0 z-0")
          }
        >
          <Image
      ...
      <div className="flex flex-col gap-4">
        ...
        {!activeRegion && (
          <p className="text-sm leading-relaxed text-[#595959] md:text-base">
            Temos dois centros de distribuição, 7 mil pontos de venda atendidos,
            milhares de entregas diárias. A Fabiano Zaffalon chega onde você
            precisa.
          </p>
        )}
        ...
        {activeRegion && (
          <>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3">
              ...
              {/* ✅ CORRIGIDO: Fazer pedido agora abre em nova janela */}
              <a
