            ...
            {status === "success" ? (
              <div className="flex flex-col items-center gap-3 rounded-[12px] bg-green-50 border border-green-200 px-6 py-10 text-center">
                ...
                <p className="text-sm text-green-600">
                  Em breve nossa equipe de <strong>{atual.label}</strong>{" "}
                  entrará em contato.
                </p>
                <button
          ...
          <div className="w-full lg:w-[360px] lg:shrink-0">
            ...
            <div className="mb-6 flex w-full overflow-hidden rounded-[8px] border border-[#D1D1D1] bg-white">
              {UNIDADES.map((u) => (
                <button
                  key={u.id}
                  onClick={() => setUnidade(u.id as typeof unidade)}
                  className={
            ...
            <div className="rounded-[12px] bg-white p-5 shadow-sm lg:bg-transparent lg:p-0 lg:shadow-none">
              ...
              <div className="mt-5 flex gap-3 lg:hidden">
                ...
                <a
                  href={`tel:${atual.telefone.replace(/\D/g, "")}`}
                  className="flex flex-1 items-center justify-center gap-2 rounded-[8px] border-2 border-[#006EB7] py-3 text-sm font-medium text-[#006EB7] hover:bg-[#006EB7] hover:text-white transition-colors"
                >
                  Ligar
                </a>
              </div>
