        ...
        <div className="rounded-[28px] bg-[#006EB7] px-8 py-10 md:rounded-[40px] md:px-14 md:py-12">
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between md:gap-12">
            ...
            <div className="flex w-full flex-col gap-3 sm:flex-row md:w-auto md:shrink-0">
              <Link
                href="#contato"
                className="flex items-center justify-center rounded-[8px] bg-white px-8 py-3.5 text-sm font-semibold text-[#006EB7] transition-colors hover:bg-[#005a96] hover:text-white h-[53px] md:w-[220px]"
              >
                Quero Comprar
              </Link>
              <Link
                href="#contato"
                className="flex items-center justify-center rounded-[8px] border-2 border-white px-8 py-3.5 text-sm font-semibold text-white transition-colors hover:bg-white hover:text-[#006EB7] h-[53px] md:w-[220px]"
              >
                Quero Representação
              </Link>
            </div>
