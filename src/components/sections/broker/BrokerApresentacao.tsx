...
const SLIDES = [
  ...
  {
    src: "/images/broker/apresentacao-broker-4.jpg",
    alt: "Produtos Nestlé Broker Fabiano Zaffalon",
  },
];

const INTERVAL = 4500;
const DURATION = 600; // ms do crossfade
...
function BrokerCarrossel() {
  ...
  const nextSlide = () => {
    if (!transitioning) goTo((currentRef.current + 1) % SLIDES.length);
  };
