...
const REGIONS = [
  {
    ...
    // Sede sempre primeira. Substitua pelas 48 cidades reais.
    cities: [
      "Pelotas - RS",
      "Rio Grande - RS",
      "Bagé - RS",
    ...
    whatsapp: "5551999999999", // substitua pelo número real
    phone: "+5551999999999", // substitua pelo número real
    orderLink: "#contato", // substitua pelo link real
  },
  {
    id: "central",
    ...
    // Sede sempre primeira. Substitua pelas 127 cidades reais.
    cities: [
      "Rio Pardo - RS",
    ...
    whatsapp: "5551988888888", // substitua pelo número real
    phone: "+5551988888888", // substitua pelo número real
    orderLink: "#contato", // substitua pelo link real
  },
  {
    id: "broker",
    ...
    // Sede sempre primeira. Substitua pelas 92 cidades reais.
    cities: [
      "Rio Pardo - RS",
      "Porto Alegre - RS",
      "Canoas - RS",
    ...
    whatsapp: "5551977777777", // substitua pelo número real
    phone: "+5551977777777", // substitua pelo número real
    orderLink: "#contato", // substitua pelo link real
  },
];
        ...
        <div className="mx-auto w-full max-w-[1280px] px-5 md:px-12">
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 md:items-center md:gap-14">
            ...
            <div className="flex flex-col">
              <p className="text-base font-semibold tracking-widest text-[#595959]">
                A Empresa
              </p>
              <h2
            ...
            {/* Foto */}
            <div className="relative h-44 w-full overflow-hidden rounded-2xl shadow-md md:h-[360px]">
              <Image
                src="/images/empresa/empresa.svg"
      ...
      >
        <div className="mx-auto w-full max-w-[1280px] px-5 md:px-12">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 md:items-center md:gap-14">
            {/* ── Mapa ──
                Mobile: altura discreta (h-36), só referência visual.
                Desktop: protagonista da seção (h-[420px]).
            */}
            ...
            <div className="flex flex-col gap-4">
              ...
              {/* Tabs
                  Problema corrigido: o wrapper -mx-5 px-5 estende o scroll
                  até a borda da tela no mobile sem vazar para fora do layout.
              ...
              */}
              ...
              {/* Label + Select
                  Label dinâmico acompanha a região ativa.
                  Sede sempre primeira, sinalizada com 📍 e "— Sede".
              ...
              */}
              <div className="flex flex-col gap-1.5">
                ...
                >
                  <option value={activeRegion.sede}>
                    📍 {activeRegion.sede} — Sede
                  </option>
                  <optgroup label="──────────────────">
                    {activeRegion.cities
              ...
              {/* Botões de contato
                  Problema corrigido: mobile usa 1 coluna (grid-cols-1) —
                  cada botão ocupa 100% da largura, área de toque confortável,
                  texto nunca quebra nem vaza.
                  A partir de 640px (sm) volta para 3 colunas como no Figma.
              */}
              <div className="grid grid-cols-3 gap-2 sm:gap-3">
                <a
