...
const REGIONS = [
  {
    ...
    description: "Atendemos toda a região Sul do estado com uma estrutura logística robusta, garantindo entregas pontuais e um atendimento consultivo de excelência.",
  ...
  },
  {
    ...
    description: "Nossa cobertura na região Central conecta os principais polos comerciais e industriais, assegurando presença constante e suporte ágil.",
  ...
  },
  {
    ...
    description: "Como Broker oficial Nestlé, operamos na Grande Porto Alegre levando as melhores marcas, produtos e lançamentos diretamente ao ponto de venda.",
...
export function About() {
  ...
  // Toggle: clica na ativa → desativa (volta ao mapa completo)
  ...
  return (
    <>
      ...
      <section id="empresa" className="bg-[#EFEFEF] pt-12 pb-0 md:pt-20 md:pb-2">
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 md:items-center md:gap-14">
            ...
            <div className="flex flex-col order-1 md:order-none">
              ...
              <p className="mt-3 text-sm leading-relaxed text-[#595959] md:text-base">
                A Fabiano Zaffalon conta com um portfólio diversificado de marcas líderes em seus
                segmentos. Focada na excelência no atendimento e na prestação de serviços. Ao longo
                de nossa trajetória, construímos uma sólida rede de parcerias, se destacando pela
                qualidade de seus produtos e pelo prazer que seus colaboradores têm em fazer parte
                desta organização.
              </p>
              <Link
                href="#contato"
            ...
            {/* Foto sede — direita */}
            {/* Salvar como: /public/images/empresa/sede.jpg */}
      ...
      {/* ══ SEÇÃO BROKER NESTLÉ ════════════════════════════════════════════
          Layout alternado: foto esquerda / texto direita
      ══════════════════════════════════════════════════════════════════════ */}
      <section id="broker" className="bg-[#EFEFEF] pt-10 pb-0 md:pt-16 md:pb-2">
        <div className="mx-auto w-full max-w-[1280px] px-5 md:px-12">
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 md:items-center md:gap-14">

            {/* Foto galpão — esquerda no desktop, abaixo do texto no mobile */}
            {/* Salvar como: /public/images/empresa/broker.jpg */}
            <div className="order-2 md:order-none relative h-44 w-full overflow-hidden rounded-2xl shadow-md md:h-[360px]">
              <Image
            ...
            <div className="flex flex-col order-1 md:order-none">
              ...
              <p className="mt-3 text-sm leading-relaxed text-[#595959] md:text-base">
                Por meio da operação de Broker Nestlé, atuamos como uma extensão estratégica de
                uma das marcas mais prestigiadas do mundo, fortalecendo sua presença no mercado
                com capilaridade e ampliando oportunidades para o varejo e food service.
              </p>
              <Link
                href="#contato"
                className="mt-5 self-start rounded-[8px] border-2 border-[#006EB7] bg-[#006EB7] px-6 py-2.5 text-sm font-medium text-white transition-colors hover:bg-white hover:text-[#006EB7]"
      ...
      {/* ══ SEÇÃO REGIÕES DE ATUAÇÃO ═══════════════════════════════════════ */}
      <section id="regioes" className="bg-[#EFEFEF] pt-2 pb-10 md:pt-4 md:pb-14">
        <div className="mx-auto w-full max-w-[1280px] px-5 md:px-12">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 md:items-center md:gap-14">

            {/* Mapa */}
            <div className="relative w-full overflow-hidden rounded-2xl h-36 md:h-[420px]">
              {/* Mapa completo — visível quando nenhuma região está ativa */}
            ...
            <div className="flex flex-col gap-4">
              ...
              {/* Tabs — toggle, nenhum ativo por padrão */}
              ...
              {/* Descrição — só aparece quando uma região está ativa */}
              {activeRegion && (
              ...
              {/* Texto padrão quando nenhuma região está selecionada */}
              {!activeRegion && (
                <p className="text-sm leading-relaxed text-[#595959] md:text-base">
                  Selecione uma região para ver as cidades atendidas e entrar em contato com o consultor responsável.
                </p>
              )}

              {/* Label + Select — só aparece quando uma região está ativa */}
              {activeRegion && (
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="cities-select" className="text-xs font-semibold uppercase tracking-wider text-[#595959]">
              ...
              {/* Botões de contato — só aparecem com região ativa */}
              {activeRegion && (
                <div className="grid grid-cols-3 gap-2 sm:gap-3">
                  <a
