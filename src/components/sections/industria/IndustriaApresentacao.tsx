        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:items-center md:gap-12">
          ...
          <div className="flex flex-col gap-5 order-1 md:order-none">
            ...
            <p className="text-sm leading-relaxed text-[#595959]">
              ...
              produtos em circulação. Requer estratégia, estrutura, relacionamento
              e capacidade de execução. Há quase 30 anos, a Fabiano Zaffalon atua
              conectando grandes marcas a milhares de pontos de venda no Rio Grande
              do Sul, desenvolvendo um trabalho baseado em confiança, compromisso e
              entendimento das necessidades da indústria.
            </p>
            <p className="text-sm leading-relaxed text-[#595959]">
          ...
          <div className="order-2 md:order-none overflow-hidden rounded-2xl">
            <div className="relative w-full" style={{ aspectRatio: "2371/1158" }}>
              <Image
